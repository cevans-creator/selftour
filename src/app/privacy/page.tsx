  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <section className="prose prose-gray max-w-none space-y-8">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2">3. SMS Messaging</h2>
        ...
        <div>
          ...
          <p>For privacy-related questions, contact us at <a href={`mailto:${email}`} className="text-blue-600 underline">{email}</a>.</p>
        </div>
      </section>
    </main>
  );
